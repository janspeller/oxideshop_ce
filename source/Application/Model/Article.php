...
class Article extends \OxidEsales\Eshop\Core\Model\MultiLanguageModel implements \OxidEsales\Eshop\Application\Model\Contract\ArticleInterface, \OxidEsales\Eshop\Core\Contract\IUrl
{
    ...
    protected function assignStock()
    {
        ...
        if (
            ...
            if ($stock > 0 && ($this->isLowStock() || $this->isLowStockWarning())) {
    ...
    private function getEffectiveStock(): ?int
    {
        if ($this->_blNotBuyableParent) {
            return $this->oxarticles__oxvarstock->value;
        }
    ...
    {
        return $this->oxarticles__oxremindamount->value >= 0
            && $this->getEffectiveStock() <= $this->oxarticles__oxremindamount->value;
    }

    private function isLowStockWarning():bool
    {
        return $this->oxarticles__oxremindamount->value === 0.0
            && $this->getEffectiveStock() <= Registry::getConfig()->getConfigParam('sStockWarningLimit');
    }
}
